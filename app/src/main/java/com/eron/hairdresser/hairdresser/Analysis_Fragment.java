 ...
 *  数据分析
 */
public class Analysis_Fragment extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        super.setContentView(R.layout.framgent_analysis);
        // Init first chart
        mUpdateOne = true;
        mChartOne = (LineChartView) super.findViewById(R.id.linechart1);
        mPlayOne = (ImageButton) super.findViewById(R.id.play1);
        ...
        // Init second chart
        mUpdateTwo = true;
        mChartTwo = (LineChartView) super.findViewById(R.id.linechart2);
        mPlayTwo = (ImageButton) super.findViewById(R.id.play2);
        ...
        // Init third chart
        mUpdateThree = true;
        mChartThree = (LineChartView) super.findViewById(R.id.linechart3);
        mPlayThree = (ImageButton) super.findViewById(R.id.play3);
    ...
    public static void dismiss(LineChartView chart, Runnable action){
        chart.dismissAllTooltips();
