 ...
 */
public class Subscribe_Fragment_ListView_Adapter extends BaseAdapter {
    private LayoutInflater inflater;
    private List<Expire_Model.ObjectBean> modelList;
    private Context context;

    public Subscribe_Fragment_ListView_Adapter(Context context, List<Expire_Model.ObjectBean> list) {
